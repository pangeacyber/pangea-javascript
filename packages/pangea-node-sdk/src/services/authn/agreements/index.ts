...
export default class Agreements extends BaseService {
  ...
  create(
    ...
    return this.post("v1/agreements/create", request);
  }
  ...
  delete(
    ...
    return this.post("v1/agreements/delete", request);
  }
  ...
  update(
    ...
    return this.post("v1/agreements/update", request);
  }
  ...
  list(
    ...
    return this.post("v1/agreements/list", request);
  }
}
