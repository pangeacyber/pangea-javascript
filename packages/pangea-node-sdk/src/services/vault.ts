...
export class VaultService extends BaseService {
  ...
  async stateChange(
    ...
    return await this.post("v2/state/change", request);
  }
  ...
  async getItem(
    ...
    return await this.post("v2/get", request);
  }
  ...
  async getBulk(
    ...
    return await this.post("v2/get_bulk", request);
  }
  ...
  async list(
    ...
    return await this.post("v2/list", request);
  }
  ...
  async update(
    ...
    return await this.post("v2/update", request);
  }
  ...
  async secretStore(
    ...
    return await this.post("v2/secret/store", request);
  }
  ...
  async secretRotate(
    ...
    return await this.post("v2/secret/rotate", request);
  }
  ...
  async symmetricGenerate(
    ...
    return await this.post("v2/key/generate", request);
  }
  ...
  async asymmetricStore(
    ...
    request.type = Vault.ItemType.ASYMMETRIC_KEY;
    return await this.post("v2/key/store", request);
  }
  ...
  async keyRotate(
    ...
    return await this.post("v2/key/rotate", request);
  }
  ...
  async encrypt(
    ...
    return await this.post("v2/encrypt", request);
  }
  ...
  async decrypt(
    ...
    return await this.post("v2/decrypt", request);
  }
  ...
  async verify(
    ...
    return await this.post("v2/verify", request);
  }
  ...
  async jwkGet(
    ...
    return await this.post("v2/jwk/get", request);
  }
  ...
  async folderCreate(
    ...
    return await this.post("v2/folder/create", request);
  }
  ...
  async encryptStructured<O>(
    ...
    return await this.post("v2/encrypt_structured", request);
  }
  ...
  async decryptStructured<O>(
    ...
    return await this.post("v2/decrypt_structured", request);
  }
  ...
  async encryptTransform(
    ...
    return await this.post("v2/encrypt_transform", request);
  }
  ...
  async decryptTransform(
    ...
    return await this.post("v2/decrypt_transform", request);
  }
