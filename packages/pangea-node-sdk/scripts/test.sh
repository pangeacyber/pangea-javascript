...
npx start-server-and-test --expect 404 \
  "npx @stoplight/prism-cli mock -d --json-schema-faker-fillProperties=false tests/testdata/prompt-guard.openapi.json" \
  4010 \
  "yarn test tests/integration2/prompt_guard.test.ts"
