...
- Add support for optional columnCustomizationPosition props, to choose if, the column customization control should appear in table or within the header. Default is in header.

## [2.0.2] - 2025-05-08

### Fixed

- Fix mode check to look at both color scheme mode (if used) else default to palette.mode
